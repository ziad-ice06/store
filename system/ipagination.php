 ...
 */
function iPagination($params = array())
{
	if (count($params) > 0)
	{
...
function create_links()
{
	...
	if ($I->config['enable_query_strings'] === TRUE OR $this->page_query_string === TRUE)
	{
	...
	elseif(isset($I->url_segments[$this->uri_segment]))
	{
		if ($I->url_segments[$this->uri_segment] != 0)
		{
			$this->cur_page = $I->url_segments[$this->uri_segment];
